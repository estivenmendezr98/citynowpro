                ...
                <div className="col-md-12 d-flex justify-content-center">
                    <div id="accordion" className="col-md-8">
                        <div className="card-faq card">
                            ...
                            >
                                <div className="card-body justifyCardBody">
                                    Si presenta problema para recordar su
                                    contraseña e ingresar al sistema de
                                    información de City Know Pro, por favor,
                                    enviar un correo a cityknowpro2@gmail.com
                        ...
                        <div className="card-faq card">
                            <button
                                className="btn-faq btn collapsed"
                                data-toggle="collapse"
                        ...
                        <div className="card-faq card">
                            ...
                            >
                                <div className="card-body justifyCardBody">
                                    ...
                                    email a cityknowpro2@gmail.com con el asunto
