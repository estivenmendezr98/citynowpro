                ...
                <div>
                    <div className="d-flex justify-content-center">
                        <div className="col-md-4">
                            <img
                                src={"/img/Mesa_de_trabajo_1_1.png"}
                                className="img-fluid"
                    ...
                    <div className="d-flex justify-content-center col-md-12">
                        <div className="descript-introPage col-md-10">
                            <div>
                                ...
                                diferentes mini juegos de City Know Pro.
                            </div>
                            <div>
                                ...
                                facilitaran a los actores educativos, el diseño
                                e implementación de acciones pertinentes en
                                cuanto a estrategias metodológicas en el aula,
                                ajustes en contenidos y logros y fortalecimiento
